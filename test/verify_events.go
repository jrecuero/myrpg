...
func main() {
	...
	if eventComp, exists := battleEvent.GetComponent("event"); exists {
	...
	if eventComp, exists := chestEvent.GetComponent("event"); exists {
		event := eventComp.(*components.EventComponent)
		fmt.Printf("   - ID: %s\n", event.ID)
		fmt.Printf("   - Name: %s\n", event.Name)
		fmt.Printf("   - Type: %s\n", event.EventType)
	...
	if eventComp, exists := dialogEvent.GetComponent("event"); exists {
		event := eventComp.(*components.EventComponent)
		fmt.Printf("   - ID: %s\n", event.ID)
		fmt.Printf("   - Name: %s\n", event.Name)
		fmt.Printf("   - Type: %s\n", event.EventType)
	...
	if eventComp, exists := infoEvent.GetComponent("event"); exists {
		event := eventComp.(*components.EventComponent)
		fmt.Printf("   - ID: %s\n", event.ID)
		fmt.Printf("   - Name: %s\n", event.Name)
		fmt.Printf("   - Type: %s\n", event.EventType)
	...
	if eventComp, exists := trapEvent.GetComponent("event"); exists {
		event := eventComp.(*components.EventComponent)
		fmt.Printf("   - ID: %s\n", event.ID)
		fmt.Printf("   - Name: %s\n", event.Name)
		fmt.Printf("   - Type: %s\n", event.EventType)
	...
	timerEvent := entities.CreateTimerEvent("timer1", "Auto Event", 600, 600, components.EventInfo, 5) // 5 second timer

	if eventComp, exists := timerEvent.GetComponent("event"); exists {
		event := eventComp.(*components.EventComponent)
		fmt.Printf("   - ID: %s\n", event.ID)
		fmt.Printf("   - Name: %s\n", event.Name)
		fmt.Printf("   - Type: %s\n", event.EventType)
